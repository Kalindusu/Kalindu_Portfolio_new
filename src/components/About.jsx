...
const About = () => {
    return ( 
        <div className="border-b border-neutral-500 pb-1">
            <h1 className="my-8 text-center text-4xl font-bold">About <span className="text-neutral-500">Me</span></h1>
            ...
            <div className=" pb-8  ">
        <Model />
        <div className="items-center gap-5 flex text-3xl text-white mt-28 container font-nav ">
